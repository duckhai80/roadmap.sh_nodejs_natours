...
},{"./helpers/bind.js":"../../node_modules/axios/lib/helpers/bind.js","process":"../../node_modules/.pnpm/process@0.11.10/node_modules/process/browser.js"}],"../../node_modules/axios/lib/core/AxiosError.js":[function(require,module,exports) {
'use strict';
...
var signup = exports.signup = function signup(event) {
...
var login = exports.login = function login(event) {
  return /*#__PURE__*/function () {
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51RR4GGEKdAqLoXLUItn0GVSgw0bVYNMpuTDs5tBPS6KryOPPKCJIdqbNyYL18Fgd6YZbMl4RuAPdA6Sx9Oigmn3x00KOBLIk3u'); // Get checkout session from API
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var updateSettings = exports.updateSettings = function updateSettings(event) {
  return /*#__PURE__*/function () {
...
var loginForm = document.querySelector('.login-form:not(.signup-form) .form');
...
var bookTourBtn = document.getElementById('book-tour-btn');
var messageAlert = document.querySelector('body').dataset.alert;
if (messageAlert) (0, _alert.showAlert)('success', messageAlert, 5);
if (mapBox) {
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(e)(name, email, password, passwordConfirm);
  });
}
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _login.login)(e)(email, password);
  });
}
if (logoutBtn) logoutBtn.addEventListener('click', function (e) {
  return (0, _login.logout)(e);
});
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(e)(formData, 'data');
  });
}
if (userPasswordForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _updateSettings.updateSettings)(e)({
...
},{"./login":"login.js","./maptiler":"maptiler.js","./stripe":"stripe.js","./updateSettings":"updateSettings.js","./alert":"alert.js"}],"../../node_modules/.pnpm/parcel-bundler@1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
