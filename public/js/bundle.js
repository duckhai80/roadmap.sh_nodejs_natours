...
var updateUserDataForm = document.querySelector('.form.form-user-data');
if (mapBox) {
...
if (updateUserDataForm) {
  updateUserDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = updateUserDataForm.name.value;
    var email = updateUserDataForm.email.value;
    (0, _updateSettings.updateUserData)(name, email);
  });
}
},{"./login":"login.js","./maptiler":"maptiler.js","./updateSettings":"updateSettings.js"}],"../../node_modules/.pnpm/parcel-bundler@1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
